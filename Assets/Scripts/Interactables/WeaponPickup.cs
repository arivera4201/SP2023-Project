...
public class WeaponPickup : Interactable
{
    ...
    public override void Interact()
    {
        if (player.score >= price)
        {
            ...
            weaponInstance.transform.parent = player.transform.GetChild(0).transform;
            weaponInstance.transform.localPosition = player.transform.GetChild(0).GetChild(1).transform.localPosition;
